<div class="modal fade" id="blog" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php if(!User::logged_in() && @$account_user_id != Database::simple_get('user_id', 'servers', ['server_id' => $_SESSION['server_id']])) { ?>
			...
			<form method="post" role="form" class="blog">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title"><?php echo $language['server']['add_blog_post']; ?></h4>
				</div>

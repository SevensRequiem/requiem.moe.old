...
$result = $database->query("SELECT `server_id`, `address`, `type`, `connection_port`, `query_port`, `date_added`, `private`, `active`, `highlight` FROM `servers` ORDER BY `server_id` DESC LIMIT {$_POST['limit']}, {$results_limit}");
...
<tr>
	...
	<td><?php echo $servers_data->type; ?></td>

...
<script>
  var lastSong = null;
  var selection = null;
  var playlist = ["media/speak.mp3", "media/flannel.mp3", "media/end.mp3", "media/black.mp3", "media/bad.mp3", "media/stolen.mp3", "media/bdhabits.mp3", "media/bulletproof.mp3"]; // List of Songs
        ...
        <a href="https://steamcommunity.com/id/SevensRequiem/" target="_blank">steam</a>
            ...
            <a href="#" onclick="toggle_visibility('discord');">discord</a>
                ...
                <a href="mailto:requiem@sevens.gq" target="_blank">email</a>
                    ...
                    <div id="hub">
                    <a href="./hub">hub (Pages / WIP)</a>
                    </div>
    <div id="t1">requiem</div>
    <div id="discord" hidden="true">#9037</div>
  </div>

...
<script>
  var lastSong = null;
  var selection = null;
  var playlist = ["media/speak.mp3", "media/flannel.mp3", "media/end.mp3", "media/black.mp3", "media/bad.mp3", "media/stolen.mp3", "media/bdhabits.mp3", "media/bulletproof.mp3", "assets/filth.mp3", "assets/kill_me.mp3", "assets/king.mp3", "assets/leave_me_alone.mp3", "assets/october.mp3", "assets/razor.mp3", "assets/sheep.mp3", "assets/sunshine.mp3", "media/in_my_mind_alone.mp3", "media/overcast.mp3", "media/joinme.mp3"]; // List of Songs
        ...
        <a href="https://steamcommunity.com/id/SevensRequiem/" target="_blank">steam</a>
            ...
            <a href="#" onclick="toggle_visibility('discord');">discord</a>
                ...
                <a href="mailto:requiem@sevens.gq" target="_blank">email</a>
                    ...
                    <div id="hub">
                    <a href="./hub">hub (add me on steam, whoever is checking my website)</a>
                    </div>

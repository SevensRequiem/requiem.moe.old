...
if(session('access_token')) {
    ...
    echo '		<h1><a href="https://requiem.moe/">requiem<span>.MOE</span></a></h1>';
    echo '		<nav>';
    echo '			<a href="#">temp1</a>';
    echo '			<a href="#">temp2</a>';
    echo '			<a href="#">temp3</a>';
    ...
    echo '            <h1><a href="https://requiem.moe/">requiem<span>.MOE</span></a></h1>';
    echo '            <nav>';
    echo '                <a href="#" class="btn">Store N/A</a>';
    echo '                <a href="../scripts" class="btn">Scripts</a>';
    echo '                <a href="../games" class="btn">Games</a>';
    echo '                <a href="../ghostemane" class="btn">☿️</a>';
    ...
    echo '                <a href="../sekrit" class="btn">Sekrit</a>';
    echo '                <a href="#" class="btn">Versions N/A</a>';
    echo '            </nav>';
    echo '            <ul>';

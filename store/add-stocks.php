...
<div class="container" style="padding-top: 110px; width: 40%;">
    ...
    <center><h2 style="padding-bottom: 20px; font-size: 25px;">Add Stock</h2></center>
    <br>
    <form action="add-stock.php" method="GET">

  <div class="form-group">
    <label for="selected_product">Choose The Product You Want To Add Stock To</label><br><br>
